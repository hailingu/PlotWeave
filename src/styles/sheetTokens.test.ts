 ...
 *
 * 范围界定（issue #278 验收标准）：
 * - 结构断言覆盖展示色属性（前景 color、背景、轮廓、SVG fill/stroke，以及
 *   border 全部简写/长形——总体、四向、逻辑方向，按结构式分类而非枚举）；
...
describe('展示色结构契约（issue #278）', () => {
  it('展示色属性分类覆盖 border 全部简写/长形（四向与逻辑方向）与 SVG fill/stroke；box-shadow 与尺寸类不算', () => {
    for (const prop of [
      'border',
      'border-top',
      'border-left',
